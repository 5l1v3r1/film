			...
			<div class="main-content">
				<div class="container-fluid">
					<?php
                      ...
                      <?php }
                      ?>
					<h3 class="page-title">Filmler</h3>
					<div class="row">
						<div class="col-md-12">
							<!-- INPUTS -->
							<div class="panel">
			                ...
			                while($yazicek=$yazisor->fetch(PDO::FETCH_ASSOC)) { $say++?>
											<tr>
												<td><?php echo $say ?></td>
												<td><?php echo $yazicek['film_isim'] ?></td>
												<td><?php echo $yazicek['film_imdb'] ?></td>
												<td><?php echo $yazicek['film_izlenme'] ?></td>
												<td><?php echo substr($yazicek['film_aciklama'],0,70) ?></td>
												<td><?php echo $yazicek['film_yil'] ?></td>
												<td><?php echo $yazicek['film_kategori'] ?></td>
												<td><a href="filmduzenle.php?film_id=<?php echo $yazicek['film_id'] ?>"><span class="label label-primary">Düzenle</span></a></td>
												<td><a href="islem/islem.php?film_id=<?php echo $yazicek['film_id']; ?>&filmsil=ok"><span class="label label-danger">Sil</span></a></td>
											</tr>
											 <?php } ?>
										</tbody>
									</table>
