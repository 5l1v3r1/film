        ...
        <div class="col-lg-12">
          <div class="owl-carousel mb-5">
            ...
            while($slidercek=$slidersor->fetch(PDO::FETCH_ASSOC)) {
             ?>
            <div class="slider"><a href="<?php echo seo($slidercek['film_isim']).'-'.$slidercek['film_id']?>"> <img src="<?php echo $slidercek['film_resim'] ?>" width="250" height="340" alt=""></a><div class="slidergit"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div></div>
            <?php } ?>
          </div>
        </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-12">
          ...
          <div class="sırala mt-4">
            ...
            $gelen = strip_tags($_POST["baslik"]);
            $gelen2 = strip_tags($_POST["kategori"]);
            $gelen3 = strip_tags($_POST["yil"]);
            $gelen4 = strip_tags($_POST["puan"]);
            $yazisor=$db->prepare("SELECT * FROM film_icerik where film_isim LIKE '%$gelen%' and film_kategori LIKE '%$gelen2%' and film_yil LIKE '%$gelen3%' and film_imdb LIKE '%$gelen4%' ORDER BY film_id DESC LIMIT $Goster,$Limit ");
          ...
          <div class="film film1">
            <img src="<?php echo $yazicek['film_resim'] ?>" alt="" width="170" height="261">
            <div class="film_git">
	            				<a href="<?php echo seo($yazicek['film_isim']).'-'.$yazicek['film_id']?>">Filmi İzle</a>
	           </div>
            <div class="film_aciklama">
								<h6><a href="single.html"><?php echo $yazicek['film_isim'] ?></a></h6>
        ...
        <nav aria-label="Page navigation example ">
          ...
          ?>
           <?php if($Sayfa > 1){?>
            <li class="page-item">
              <a class="page-link" href="filmrobotu.php?sayfa=<?=$Sayfa - 1?>" tabindex="-1">Önceki</a>
            </li>
            <?php } ?>
            <?php
            for($b = 1 ; $b <= $a ; $b++){
            echo '<li class="page-item"><a class="page-link" href="filmrobotu.php?sayfa='. $b . ' ">'. $b . '</a></li>';
            }
            ?>
            <li class="page-item">
              <a class="page-link" href="filmrobotu.php?sayfa=<?=$Sayfa + 1?>">Sonraki</a>
            </li>
            <?php
            if (empty($yazi)) {
