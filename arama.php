      ...
      <div class="row">
        <div class="col-lg-8 col-sm-12">
          ...
          <div class="sırala mt-4">
            ...
            $gelen = strip_tags($_POST["arama"]);
            $yazisor=$db->prepare("SELECT * FROM film_icerik where film_isim LIKE '%$gelen%' ORDER BY film_id DESC LIMIT $Goster,$Limit ");
        ...
        <nav aria-label="Page navigation example ">
          ...
          ?>
           <?php if($Sayfa > 1){?>
            <li class="page-item">
              <a class="page-link" href="arama.php?sayfa=<?=$Sayfa - 1?>" tabindex="-1">Önceki</a>
            </li>
            <?php } ?>
            <?php
            for($b = 1 ; $b <= $a ; $b++){
            echo '<li class="page-item"><a class="page-link" href="arama.php?sayfa='. $b . ' ">'. $b . '</a></li>';
            }
            ?>
            <li class="page-item">
              <a class="page-link" href="arama.php?sayfa=<?=$Sayfa + 1?>">Sonraki</a>
            </li>
            <?php
            if (empty($yazi)) {
